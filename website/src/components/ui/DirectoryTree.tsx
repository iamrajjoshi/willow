...
const TREE_LINES = [
  ...
  },
  {
    ...
    dir: "status/",
    file: "",
    annotation: "agent session status",
  },
  { structure: "    └── ", dir: "myrepo/", file: "", annotation: "" },
  { structure: "        ├── ", dir: "auth-refactor/", file: "", annotation: "" },
  {
    structure: "        │   └── ",
    dir: "",
    file: "claude/<session_id>.json",
    annotation: "",
  },
  { structure: "        └── ", dir: "payments/", file: "", annotation: "" },
  {
    structure: "            └── ",
    dir: "",
    file: "codex/<session_id>.json",
    annotation: "",
  },
] as const;
